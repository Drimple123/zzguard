    ...
    with HasNonDiplomaticTileParameters
{
  ...
  val rocc_bits_out: Option[BundleBridgeSource[UInt]] = if(tileParams.tileId == 0) Some(BundleBridgeSource[UInt](Some(() => UInt(55.W)))) else None
  ...
  // val rocc_bits_out_3: Option[BundleBridgeSource[UInt]] = if(tileParams.tileId == 0) Some(BundleBridgeSource[UInt](Some(() => UInt(55.W)))) else None
  // val rocc_valid_out_3:Option[BundleBridgeSource[Bool]] = if(tileParams.tileId == 0) Some(BundleBridgeSource[Bool](Some(() => Bool()))) else None
  // val rocc_ready_in_3:Option[BundleBridgeSink[Bool]] = if(tileParams.tileId == 0) Some(BundleBridgeSink[Bool](Some(() => Bool()))) else None
  ...
  // val lors_ready_in: Option[BundleBridgeSink[Bool]] = if(tileParams.tileId == 0) Some(BundleBridgeSink[Bool](Some(() => Bool()))) else None
  
  // val addr_in: Option[BundleBridgeSink[UInt]] = if(tileParams.tileId == 1) Some(BundleBridgeSink[UInt](Some(() => UInt(40.W)))) else None
  ...
  // val funct_in: Option[BundleBridgeSink[UInt]] = if(tileParams.tileId == 1) Some(BundleBridgeSink[UInt](Some(() => UInt(7.W)))) else None
  ...
  // val rocc_bits_in_3: Option[BundleBridgeSink[UInt]] = if(tileParams.tileId == 3) Some(BundleBridgeSink[UInt](Some(() => UInt(55.W)))) else None
  // val rocc_valid_in_3: Option[BundleBridgeSink[Bool]] = if(tileParams.tileId == 3) Some(BundleBridgeSink[Bool](Some(() => Bool()))) else None
  // val rocc_ready_out_3: Option[BundleBridgeSource[Bool]] = if(tileParams.tileId == 3) Some(BundleBridgeSource[Bool](Some(() => Bool()))) else None
  ...
  // val data_ready: Option[BundleBridgeSink[Bool]] = if(tileParams.tileId == 0) Some(BundleBridgeSink[Bool](Some(() => Bool()))) else None
  val data_bits_out_nodes: Option[Seq[BundleBridgeSource[UInt]]] = if(tileParams.tileId == 0)
                                                          Some(Seq.fill(10)(BundleBridgeSource[UInt](Some(() => UInt(160.W)))))
                                                        else
                                                          None
  val data_valid_out_nodes: Option[Seq[BundleBridgeSource[Bool]]] = if(tileParams.tileId == 0)
                                                          Some(Seq.fill(10)(BundleBridgeSource[Bool](Some(() => Bool()))))
                                                        else
                                                          None
  val data_ready_in_nodes: Option[Seq[BundleBridgeSink[Bool]]] = if(tileParams.tileId == 0)
                                                          Some(Seq.fill(10)(BundleBridgeSink[Bool](Some(() => Bool()))))
                                                        else
                                                          None


  val data_bits_in_nodes: Option[Seq[BundleBridgeSink[UInt]]] = if(tileParams.tileId == 1)
                                                          Some(Seq.fill(10)(BundleBridgeSink[UInt](Some(() => UInt(160.W)))))
                                                        else
                                                          None
  val data_valid_in_nodes: Option[Seq[BundleBridgeSink[Bool]]] = if(tileParams.tileId == 1)
                                                          Some(Seq.fill(10)(BundleBridgeSink[Bool](Some(() => Bool()))))
                                                        else
                                                          None
  val data_ready_out_nodes: Option[Seq[BundleBridgeSource[Bool]]] = if(tileParams.tileId == 1)
                                                          Some(Seq.fill(10)(BundleBridgeSource[Bool](Some(() => Bool()))))
                                                        else
                                                          None 
  ...
  // val data_bits_out_nodes_3: Option[Seq[BundleBridgeSource[UInt]]] = if(tileParams.tileId == 0)
  //                                                         Some(Seq.fill(3)(BundleBridgeSource[UInt](Some(() => UInt(160.W)))))
  //                                                       else
  //                                                         None
  // val data_valid_out_nodes_3: Option[Seq[BundleBridgeSource[Bool]]] = if(tileParams.tileId == 0)
  //                                                         Some(Seq.fill(3)(BundleBridgeSource[Bool](Some(() => Bool()))))
  //                                                       else
  //                                                         None
  // val data_ready_in_nodes_3: Option[Seq[BundleBridgeSink[Bool]]] = if(tileParams.tileId == 0)
  //                                                         Some(Seq.fill(3)(BundleBridgeSink[Bool](Some(() => Bool()))))
  //                                                       else
  //                                                         None


  // val data_bits_in_nodes_3: Option[Seq[BundleBridgeSink[UInt]]] = if(tileParams.tileId == 3)
  //                                                         Some(Seq.fill(3)(BundleBridgeSink[UInt](Some(() => UInt(160.W)))))
  //                                                       else
  //                                                         None
  // val data_valid_in_nodes_3: Option[Seq[BundleBridgeSink[Bool]]] = if(tileParams.tileId == 3)
  //                                                         Some(Seq.fill(3)(BundleBridgeSink[Bool](Some(() => Bool()))))
  //                                                       else
  //                                                         None
  // val data_ready_out_nodes_3: Option[Seq[BundleBridgeSource[Bool]]] = if(tileParams.tileId == 3)
  //                                                         Some(Seq.fill(3)(BundleBridgeSource[Bool](Some(() => Bool()))))
  //                                                       else
  //                                                         None                                                         
