...
{ this: LazyModule with Attachable =>
  ...
  // val addr_mid  = BundleBridgeIdentityNode[UInt]()
  ...
  val data_bits_mid = Seq.fill(10)(BundleBridgeIdentityNode[UInt]())
  val data_valid_mid = Seq.fill(10)(BundleBridgeIdentityNode[Bool]())
  val data_ready_mid = Seq.fill(10)(BundleBridgeIdentityNode[Bool]())
