...
{ this: LazyModule with Attachable =>
  ...
  val data_bits_mid = Seq.fill(8)(BundleBridgeIdentityNode[UInt]())
  val data_valid_mid = Seq.fill(8)(BundleBridgeIdentityNode[Bool]())
  val data_ready_mid = Seq.fill(8)(BundleBridgeIdentityNode[Bool]())
